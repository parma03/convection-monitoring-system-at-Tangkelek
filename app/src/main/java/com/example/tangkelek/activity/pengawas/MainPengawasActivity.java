...
import com.example.tangkelek.activity.admin.DialogProfileAdminActivity;
import com.example.tangkelek.activity.admin.MainAdminActivity;
import com.example.tangkelek.activity.admin.PencapainProduksiActivity;
import com.example.tangkelek.activity.admin.ProduksiAdminFragment;
import com.example.tangkelek.activity.manajer.HomeManajerFragment;
...
import com.example.tangkelek.databinding.ActivityMainManajerBinding;
import com.example.tangkelek.databinding.ActivityMainPengawasBinding;
...
public class MainPengawasActivity extends AppCompatActivity {
    private ActivityMainPengawasBinding binding;
    PrefManager prefManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMainPengawasBinding.inflate(getLayoutInflater());
        ...
        replaceFragment(new HomeManajerFragment());
        binding.ButtomNav.setOnItemSelectedListener(item -> {
            switch (item.getItemId()){
                ...
                case R.id.Monitoring:
                    replaceFragment(new MonitoringManajerFragment());
                    break;
                case R.id.Produksi:
    ...
    private void performLaporan() {
        Intent intent = new Intent(MainPengawasActivity.this, PencapainProduksiActivity.class);
        ...
        PopupDialog.getInstance(this)
                ...
                .showDialog(new OnDialogButtonClickListener() {
                    ...
                    public void onPositiveClicked(Dialog dialog) {
                        PrefManager prefManager = new PrefManager(MainPengawasActivity.this);
                        prefManager.setLoginStatus(false);
                        Intent intent = new Intent(MainPengawasActivity.this, LoginActivity.class);
