...
import com.example.tangkelek.activity.admin.HomeAdminFragment;
...
public class MainManajerActivity extends AppCompatActivity {
    private ActivityMainManajerBinding binding;
    PrefManager prefManager;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityMainManajerBinding.inflate(getLayoutInflater());
    ...
    private void performLaporan() {
        Intent intent = new Intent(MainManajerActivity.this, PencapainProduksiActivity.class);
        ...
        PopupDialog.getInstance(this)
                ...
                .showDialog(new OnDialogButtonClickListener() {
                    ...
                    public void onPositiveClicked(Dialog dialog) {
                        PrefManager prefManager = new PrefManager(MainManajerActivity.this);
                        prefManager.setLoginStatus(false);
                        Intent intent = new Intent(MainManajerActivity.this, LoginActivity.class);
